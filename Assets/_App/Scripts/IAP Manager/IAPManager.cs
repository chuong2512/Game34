...
public class IAPKey
{
    public const string PACK1 = "do_choi_pack1";
    public const string PACK2 = "do_choi_pack2";
    public const string PACK3 = "do_choi_pack3";
    public const string PACK4 = "do_choi_pack4";
    public const string PACK5 = "do_choi_pack5";
}
